import { CollectionProperty, LookupProperty, LookupIdProperty, CollectionIdsProperty, PrimaryKeyField, StringField, NumberField, BooleanField, NullableBooleanField, DateTimeField, ImageField, ListField, NullableStringField, NullableNumberField, NullableDateTimeField, NullableDateField, FileField, ChoiceField, NullableChoiceField, JsonField, DateField, FieldBase } from './fields';
 ...
 */
export type AlternateKey = `${string}=${string}` | `${string}=${string},${string}=${string}`;
/**
 ...
 */
export type Infer<T> = T extends null | undefined ? T : T extends DataverseTable<infer U> ? Infer<U> : T extends CollectionProperty<infer U> ? Infer<U>[] : T extends LookupProperty<infer U> ? Infer<U> | null : T extends FieldBase<infer U> ? U : {
 ...
 */
export type GenericNavigationProperty = CollectionProperty<GenericProperties> | LookupProperty<GenericProperties> | LookupIdProperty | CollectionIdsProperty;
/**
